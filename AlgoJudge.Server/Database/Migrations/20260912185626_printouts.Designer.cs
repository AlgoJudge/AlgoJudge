...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("FileReferences", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FileReferences_SingleOwner", "num_nonnulls(\"ProblemVersionId\", \"ActivityId\", \"SubmissionId\", \"EvaluationJobId\", \"RunnerId\", \"InstanceId\", \"PrintoutId\") = 1");
                        });
                });
            ...
            modelBuilder.Entity("AlgoJudge.Server.Database.Models.Printout", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("SourceDisposedAt")
                        .HasColumnType("timestamptz");
                    ...
                    b.HasIndex("ActivityId", "RequestedAt");

                    b.HasIndex("State", "RequestedAt");

                    b.ToTable("Printouts", (string)null);
                });
            ...
            modelBuilder.Entity("AlgoJudge.Server.Database.Models.FileReference", b =>
                {
                    ...
                    b.HasOne("AlgoJudge.Server.Database.Models.Printout", "Printout")
                        .WithMany("Files")
                        .HasForeignKey("PrintoutId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("AlgoJudge.Server.Database.Models.Printout", b =>
                {
                    ...
                    b.HasOne("AlgoJudge.Server.Database.Models.User", "RequestedBy")
                        .WithMany()
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AlgoJudge.Server.Database.Models.User", "ResolvedBy")
                        .WithMany()
