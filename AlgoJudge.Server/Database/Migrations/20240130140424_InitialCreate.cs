...
namespace AlgoJudge.Server.Database.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SeriesSeriesProblem",
                columns: table => new
                {
                    SeriesId = table.Column<int>(type: "integer", nullable: false),
                    SeriesProblemsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesSeriesProblem", x => new { x.SeriesId, x.SeriesProblemsId });
                    table.ForeignKey(
                        name: "FK_SeriesSeriesProblem_SeriesProblems_SeriesProblemsId",
                        column: x => x.SeriesProblemsId,
                        principalTable: "SeriesProblems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeriesSeriesProblem_Series_SeriesId",
                        column: x => x.SeriesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    SeriesProblemId = table.Column<int>(type: "integer", nullable: false),
                    ActivityId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeriesSeriesProblem_SeriesProblemsId",
                table: "SeriesSeriesProblem",
                column: "SeriesProblemsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_SeriesProblemId",
                table: "Submissions",
